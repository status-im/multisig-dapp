...
exports.getParamFromTxEvent = (transaction, paramName, contractFactory, eventName) => {
...
exports.increaseTimestamp = (web3, increase) => {
    return new Promise((resolve, reject) => {
        web3.currentProvider.sendAsync({
            method: "evm_increaseTime",
            params: [increase],
