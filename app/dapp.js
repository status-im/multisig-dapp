                ...
                {contractAddress ?
                    <Nav className="mr-auto">
                        <NavDropdown title={<span><svg className="svg-icon" viewBox="0 0 20 20">
                            ...
                            <NavDropdown.Item as="div"><LinkContainer to={"/" + contractAddress + "/transactions"}><Nav.Link><svg className="svg-icon" viewBox="0 0 20 20">
                            ...
                            <NavDropdown.Divider />
                            <NavDropdown.Item as="div"><LinkContainer to={"/" + contractAddress + "/transactions/pending"}><Nav.Link><svg className="svg-icon" viewBox="0 0 20 20">
                            ...
                            <NavDropdown.Item as="div"><LinkContainer to={"/" + contractAddress + "/transactions/executed"}><Nav.Link><svg className="svg-icon" viewBox="0 0 20 20">
                        ...
                        <LinkContainer to={"/" + contractAddress + "/owners"}><Nav.Link><svg className="svg-icon" viewBox="0 0 20 20">
                    ...
                    <Route path="/:address/transactions/:mode?" render={({ match }) => (
                        ...
                        <Container id="transactions">
                            ...
                            <MSWTransactionTable
                                ...
                                MultiSigWallet={this.state.MultiSigWallet}
